...
<head>
    ...
    <style>
        ...
        .badge-aktif { background: #d1fae5; color: #065f46; padding: 2px 8px; border-radius: 99px; font-size: 13px; }
        .badge-nonaktif { background: #fee2e2; color: #991b1b; padding: 2px 8px; border-radius: 99px; font-size: 13px; }
